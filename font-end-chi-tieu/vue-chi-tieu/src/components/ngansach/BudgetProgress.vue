<template>
  <div class="progress-container">
    <div class="d-flex justify-content-between align-items-center mb-1">
      ...
      <div class="text-end">
        <span class="fw-bold text-success">{{ currency(props.actualAmount) }}</span>
        <span class="text-muted mx-1">/</span>
        <span class="fw-bold text-danger">{{ currency(props.amount) }}</span>
      </div>
    </div>
...
const colorClass = computed(() => {
  ...
  if (props.actualAmount > props.amount) return 'bg-danger';
